...
const Services = () => {
    ...
    return (
        <div className="bg-secondary rounded-2xl p-5 md:p-20 space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
                {
                    allServices.map((service, index) => (
                        <div key={index} className="bg-white p-4 md:p-8 rounded-2xl flex flex-col items-center gap-5 text-center">
